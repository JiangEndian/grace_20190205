...
dir_name = '20210201Record_2'
#file_name = input('输入文件名：')
file_list = os.listdir('../statics/grace_voice/%s' % dir_name)
file_list.sort()
#print(file_list)
#exit(0)
...
def addEveryWeek(file_name):
    ...
    f_name = '%s/%s' % (dir_name, file_name.split('.')[0])
    #input(f_name)
    voice_number += 1
