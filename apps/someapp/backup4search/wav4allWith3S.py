...
listTemp = []
oneFlag = False
#终极版（或许），Google录音的最大空白是1S，可能断句在无空白，加上3S，然后设为2.8S的，无论是最大空白成为4S，还是无空白的3S，都能成为1个断句的，而1S原来最大也不能断句
spaceLength = 2.8*88200 #差不多的数字，在原有的上面加上0.5S的即可
#0.9*1.5=1.4s, 在最大的上面加上0.9S。1.4*88200=123479
#原来最大的是0.9s，2倍是1.8s，最长已经是1.2了。空白就1就好吧。44100，得×2
#不知道为什么，40000不行，干脆×2吧。现在反正是看不懂了。。。
#原有的最大空白是0.6S，新空白是两倍即1.2S，此空白长度为1.5倍，即0.9S，0.9×44100=40000左右
