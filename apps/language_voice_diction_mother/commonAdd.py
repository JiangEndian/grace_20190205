...
def addEveryWeek():
    ...
    if True:
        ...
        common.add(Ymd=getdaystime(9), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(15), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(16), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(26), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(27), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(46), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(47), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(76), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(77), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(126), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(127), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(160), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(161), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(260), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(261), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(360), Con=con, Other1=env, Other2=f_name)
        common.add(Ymd=getdaystime(361), Con=con, Other1=env, Other2=f_name)
