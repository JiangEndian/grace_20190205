...
def printall_dict(dict_table):
    for one in dict_table:
        print(one)
def showAllTable():
    global common
    global every_week
    global every_month
    global every_year
    printall_dict(common.find())
    printall_dict(every_week.find())
    printall_dict(every_month.find())
    printall_dict(every_year.find())
