...
def editAllTable():
    ...
    file_name_number = 20190129202634

    for data in every_week.find():
        every_week.update(NAME='Con', value=data[2], Other3=str(file_name_number)+'.mp3')
        file_name_number += 1
    for data in every_month.find():
        every_month.update(NAME='Con', value=data[2], Other3=str(file_name_number)+'.mp3')
        file_name_number += 1
    for data in every_year.find():
        every_year.update(NAME='Con', value=data[2], Other3=str(file_name_number)+'.mp3')
        file_name_number += 1
